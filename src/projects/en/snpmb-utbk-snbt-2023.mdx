...
<Image src={biodataPageScreenshot} alt="Screenshot of Biodata Page" />
...
<Image src={portofolioPageScreenshot} alt="Screenshot of Portfolio Page" />

### Pusat UTBK Page

This page allows applicants to book seats at Pusat UTBK, with a queue-based system to ensure seat allocation integrity.

<Image src={pusatUtbkPageScreenshot} alt="Screenshot of Pusat UTBK Page" />
