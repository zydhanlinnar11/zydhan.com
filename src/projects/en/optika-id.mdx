...
<Image placeholder="blur" src={homePageScreenshot} alt="Home Page" />

### News Page

<Image placeholder="blur" src={newsPageScreenshot} alt="News Page" />
...
<Image
  ...
  alt="News Creation Page"
/>

### Dashboard Page

<Image placeholder="blur" src={dashboardPageScreenshot} alt="Dashboard Page" />

### Profile Page

<Image placeholder="blur" src={profilePageScreenshot} alt="Profile Page" />
...
<Image
  ...
  alt="Penukaran Poin Page"
/>

### Admin Page

<Image placeholder="blur" src={adminPageScreenshot} alt="Admin Page" />
